...
function setupSwagger(app: INestApplication, configService: ConfigService) {
	LoggerService.info('Setting up OpenApi for the / route. OpenApi docs at /api/app', 'main.ts.setupSwagger');
...
async function bootstrap() {
	...
	LoggerService.info(`NestJS App bootstrapped and listening on ${await app.getUrl()}`, 'main.ts.bootstrap');
}
bootstrap();
